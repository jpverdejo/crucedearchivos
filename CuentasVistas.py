...
class CuentaVista:
    ...
    def __repr__(self):
        return "<CuentaVista n_cuenta='%s', linea_sobregiro='%s', fecha_creacion='%s', rut='%s', nombre='%s'>" % (self.n_cuenta, self.linea_sobregiro, self.fecha_creacion, self.rut, self.nombre)
